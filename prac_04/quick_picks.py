...
def main():
    ...
    for i in range(1, number_of_picks + 1):
        ...
        print('{0:>2d} {1:>2d} {2:>2d} {3:>2d} {4:>2d} {5:>2d}'.format(quick_pick_numbers[0], quick_pick_numbers[1],
                                                                       quick_pick_numbers[2], quick_pick_numbers[3],
                                                                       quick_pick_numbers[4], quick_pick_numbers[5]))
